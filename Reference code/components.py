...
class BertEmbed(nn.Module):
    ...
    def __init__(self, cfg: Union[Dict, HookedTransformerConfig]):
        ...
        # self.token_type_embed = TokenTypeEmbed(cfg) # DistilBERT doesn't use these but if none are passed, it shouldn't affect the output values EDIT: jk it fucks it up
        self.ln = LayerNorm(cfg)
